import type { DeepPartial } from '@/interfaces/deep-partial.interface';
import { isObject } from '@/interfaces/is-object.interface';
import { deepCompare } from './deep-compare.utils';
